...
- Jeder Historie-Eintrag zeigt das Format: "<Operand1> <Operator> <Operand2> = <Ergebnis>" (z.B. "XII + V = XVII")
- Die Historie wird beim Schließen der App gelöscht (keine Persistenz)
...
- Array/Liste für Historie-Speicherung (in-memory, keine Persistenz)
...
- Logging: Historie-Zugriffe werden nicht protokolliert (nur bei Fehlern: "[TIMESTAMP] [ERROR] [HISTORY_ERROR] [MESSAGE]")
